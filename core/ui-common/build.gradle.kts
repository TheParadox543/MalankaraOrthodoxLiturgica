...
kotlin {
    androidLibrary {
        namespace = "com.paradox543.malankaraorthodoxliturgica.core.ui"
...
compose.resources {
    publicResClass = true
    packageOfResClass = "com.paradox543.malankaraorthodoxliturgica.core.ui"
