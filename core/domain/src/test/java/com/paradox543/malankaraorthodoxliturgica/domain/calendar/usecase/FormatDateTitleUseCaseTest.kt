...
class FormatDateTitleUseCaseTest {
    ...
    fun `uses th suffix for 11th, 12th, 13th (special cases)`() {
        ...
        val result12 = useCase(event12, AppLanguage.ENGLISH, currentYear)
        ...
        val result13 = useCase(event13, AppLanguage.ENGLISH, currentYear)
    ...
    fun `formats Malayalam title with year prefix`() {
        ...
        val result = useCase(event, AppLanguage.MALAYALAM, currentYear)
